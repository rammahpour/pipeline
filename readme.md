...
```js
export const domain = 'dev-e2bkdkncmwe4tu1b.us.auth0.com';
export const clientId = 'CB9Qxg1TQlbG5kMw8VxjeNKtLEpPM89b';
```
...
```text
com.auth0.samples://dev-e2bkdkncmwe4tu1b.us.auth0.com/capacitor/com.auth0.samples/callback
```
